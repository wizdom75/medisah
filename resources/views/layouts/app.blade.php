...
<html lang="en">
    ...
    <head>
        ...
        <meta content="Stock tracking software" name="description" />
        <meta content="Medisah" name="author" />
        <!-- App favicon -->
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="{{ getAvatar(auth()->user()->id ) }}"
                                    alt="Header Avatar">
                            </button>
                        ...
                        <input id="auth_user" type="hidden" name="auth_user" value="{{ auth()->user() }}">
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="{{ route('items.index') }}" class=" waves-effect">
            ...
            <div class="main-content">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-12">
                                &copy; <script>document.write(new Date().getFullYear())</script> {{ env('APP_NAME') }} <span class="d-none d-sm-inline-block"> - Crafted with <i class="mdi mdi-heart text-danger"></i></span>
                            </div>
                        </div>
                    </div>
                </footer>
